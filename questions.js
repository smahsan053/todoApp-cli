...
function initializeUpdateItemQuestions() {
...
function initializeDeleteItemQuestions() {
    const todolist = todo.instance; // Assuming todo.instance is the instance of the todo class
...
export { taskList, addItemQuestions, addMoreItemQuestions, initializeUpdateItemQuestions, updateItemQuestions, initializeDeleteItemQuestions };
